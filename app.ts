...
class Form {
  ...
  nombreGastoInput: HTMLInputElement;
  ...
  constructor() {
    ...
    this.nombreGastoInput = document.getElementById(
      'nombre-gasto'
    )! as HTMLInputElement;
    this.valorInput = document.getElementById('valor')! as HTMLInputElement;
    this.fechaInput = document.getElementById('fecha')! as HTMLInputElement;
    this.categoriaInput = document.getElementById(
      'categoria'
    )! as HTMLInputElement;
  ...
  info(gasto: string, valor: number, fecha: string, categoria: string) {
  ...
  adicionGasto(event: Event) {
    event.preventDefault();
    this.info(
      this.nombreGastoInput.value,
...
class RenderElements {
  ...
  DOMList(){
    const listaGastosTemplate = document.getElementById(
      'lista-gastos'
    ...
    const gastoTemplate = document.getElementById(
      'gasto'
    )! as HTMLTemplateElement;
